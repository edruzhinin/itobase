...
namespace ADMethods
{
    ...
    public class ADMethodsAccountManagement
    {
        ...
        public string GetUserGUID(string sUserName)
        {
            if (!IsUserExisiting(sUserName))
                return null;
            return GetUser(sUserName).Guid.ToString();
        }

        public string GetUserFIO(string sUserName)
        {
            PrincipalContext oPrincipalContext = GetPrincipalContext();
            ...
            string strFIO = oUserPrincipal.Surname.ToString() + " " + oUserPrincipal.GivenName.ToString();

            if (oUserPrincipal.MiddleName!=null)
                strFIO=strFIO+" "+oUserPrincipal.MiddleName.ToString();
        ...
        public GroupPrincipal GetGroup(string sOU, string sGroupName)
        {
